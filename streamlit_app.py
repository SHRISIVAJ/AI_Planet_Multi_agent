...
if not SERPER_API_KEY:
    st.warning("Please set your SERPER_API_KEY as an environment variable or in a .env file.")
...
st.markdown("---")
st.markdown("**App hosted on Streamlit Cloud.** [Learn more](https://streamlit.io/cloud)")
